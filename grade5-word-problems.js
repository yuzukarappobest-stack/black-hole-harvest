...
const buildProblems = () => {
  ...
  [[8.4,4,"リボン"],[7.5,3,"ジュース"],[9.6,6,"ひも"],[6.8,2,"布"],[12.6,7,"テープ"],[10.5,5,"牛乳"],[14.4,8,"紙"],[5.4,3,"ロープ"],[16.2,6,"花"],[18,9,"えんぴつ"],[11.2,4,"水"],[13.5,5,"クッキー"],[7.2,8,"シール"],[15.6,6,"カード"],[9,12,"ノート"]].forEach(([total,count,item]) => problems.push(make("小数のわり算", `${item}が 全部で ${total} あります。${count}人で 同じ数ずつ 分けます。\n1人分は いくつですか。`, total / count)));
