window.MUSHI_DATA = (() => {
  ...
  const decks={
    ...
    // 「色彩の加護」を狙い撃ちする対策構築。
    // カイコの＜くちなし＞で色彩の加護そのものを消し、トノサマバッタの＜相変異＞を予備ロックにする。
    // 蟲術の演舞で刺蠅の血盟からロック役を守り、ロック下でデメリットが消える高効率虫で押し切る。
    metaColorCounter:{name:'環境：色彩対策',ids:[
      443,443,833,833,312,312,636,636,835,835,
      518,518,621,621,760,760,253,253,351,351
    ]},
