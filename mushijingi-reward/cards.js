window.MUSHI_DATA = (() => {
  ...
  cards[403]=insect(403,'ムカシヤンマ','red',4,600,[A('とびかかる',600)],{type:'ancientFossil',text:'＜生きた化石＞ 自分の捨て札の＜生きた化石＞を持つ虫1つにつき、出すためのコストを1減らす。'},'booster4');
  ...
  const decks={
    ...
    // mushijingi-cardlist.com「軍隊アリデッキ」掲載レシピ（2026-09-15更新）
    metaArmyAnt:{name:'環境：軍隊アリ',ids:[
      1,1,2,2,21,21,406,406,413,413,408,408,29,29,33,33,27,125,125,118
    ]},
    // mushijingi-cardlist.com「ヘラクレスオオカブトLRデッキ」掲載レシピ（2026-08-01更新）
    metaHercules:{name:'環境：ヘラクレス青単',ids:[
      34,34,37,37,36,36,46,46,45,45,53,53,54,54,60,60,125,125,100,100
    ]},
    // mushijingi-cardlist.com「スマトラLR多色デッキ」掲載レシピ（2026-08-01更新）
    metaSumatra3Color:{name:'環境：スマトラ3色',ids:[
      716,716,37,37,22,22,28,28,53,53,60,60,242,242,96,96,125,125,764,764
    ]},
    // mushijingi-cardlist.com「蜂デッキ」掲載レシピ（2026-08-01更新）
    metaBee:{name:'環境：蜂',ids:[
      701,701,703,703,8,8,702,702,511,511,212,212,513,513,28,28,125,125,764,764
    ]},
    // 「色彩の加護」専用対策。v6構成探索（約75万試合）の最良構成。
    // ハチ高速展開を維持しつつ、電気虫の稲妻×2でHP1000以下の色彩主力を即処理。
    // ナナホシ枠を青のニホンミツバチ＋ヤマトハキリバチへ替え、色相性も補完する。
    metaColorCounter:{name:'環境：色彩対策',ids:[
      701,701,703,703,8,8,702,702,511,511,
      212,212,513,513,125,125,253,253,60,824
    ]},
    // 2026/9 第8弾環境の公開シロアリ構築を参考にしたコロニービート。
    // 毒汁噴出・迎撃・蛹の冬籠りで捨て札を作り、分解で裏返して＜コロニー＞を育てる。
    metaTermite:{name:'環境：シロアリ',ids:[
      842,842,843,843,844,844,
      840,840,841,841,846,846,
      558,558,559,559,860,860,862,862
    ]}
  };
