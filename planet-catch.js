...
const BODY_TYPES = [
  ...
  { name: "火星", points: 4, load: 1, radius: 13, color: "#df7452", weight: 14 },
  ...
  { name: "木星", points: 16, load: 4, radius: 30, color: "#d18b62", weight: 6 },
  { name: "太陽", points: 36, load: 6, radius: 34, color: "#ffd24d", weight: 3, sun: true },
];
