window.MUSHI_DATA = (() => {
  ...
  const decks={
    ...
    // 「色彩の加護」を狙い撃ちする対策構築。
    // 蚕の口封じで相手の＜＞技を手札・エサ・場ごと止め、カイコの＜くちなし＞と相変異を重ねて色彩展開を封じる。
    // 蟲術の演舞で刺蠅の血盟を止め、低～中コストの高打点虫と除去でテンポを取り続ける。
    metaColorCounter:{name:'環境：色彩対策',ids:[
      443,443,863,863,833,833,760,760,312,312,
      606,606,742,742,621,621,253,253,351,351
    ]},
