window.MUSHI_DATA = (() => {
  ...
  const decks={
    ...
    // 「色彩の加護」を狙い撃ちする対策構築。
    // ＜相変異＞で両者のエサ色を無色化し、＜蛇の目＞・樹液吸収・シロガネタックルで色エサを崩す。
    // 超神通力で刺蠅の血盟などの術を止め、漆塗り/鴉塗りで裏向きエサを逆利用する。
    metaColorCounter:{name:'環境：色彩対策',ids:[
      833,833,829,829,624,624,518,518,517,517,
      519,519,240,240,345,345,723,723,253,253
    ]},
