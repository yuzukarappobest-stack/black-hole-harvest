window.MUSHI_DATA = (() => {
  ...
  cards[40].image='./images/cards/kabutomushi.jpg';
  ...
  // ===== 第3弾 =====
  // 赤の虫
  cards[301]=insect(301,'オオエンマハンミョウ','red',6,1700,[A('神のアギト',1000),A('破壊のアギト',1400,'targetHasEnhance','強化カードがついている相手の虫にだけ使用できる。')],null,'booster3');
