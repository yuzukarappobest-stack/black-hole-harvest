window.MUSHI_DATA = (() => {
  ...
  const decks={
    ...
    // 「色彩の加護」専用対策。v8ランダム構成探索（93.2万試合）の最良構成。
    // メンガタクワガタ＜威嚇の面＞で刺蠅の血盟を吸い、女王などの主力を保護。
    // 電気虫の稲妻×2で色彩の加護持ちを即処理し、ハチの展開速度で押し切る。
    metaColorCounter:{name:'環境：色彩対策',ids:[
      701,701,703,703,8,212,426,702,511,511,
      824,212,513,513,824,607,253,253,60,426
    ]},
